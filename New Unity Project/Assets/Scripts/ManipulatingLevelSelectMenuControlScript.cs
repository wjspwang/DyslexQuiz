...
public class ManipulatingLevelSelectMenuControlScript : MonoBehaviour
{
    public Text score;
    ...
    void Start()
    {
        ...
        ManipulateLevelPassed -= 68;
        Debug.Log(ManipulateLevelPassed + "");
        switch (ManipulateLevelPassed)
        {
            case 1:
        ...
        PlayerPrefs.SetInt(PlayerPrefs.GetString("username") + "ManipScore", ActiveStarCounter);
        score.text = "Score: " + PlayerPrefs.GetInt(PlayerPrefs.GetString("username") + "ManipScore");
        Debug.Log("ManipScore is " + PlayerPrefs.GetInt(PlayerPrefs.GetString("username") + "ManipScore"));
    ...
    public void resetPlayerPrefs()
    {
        ...
        level19Button.interactable = false;
        level20Button.interactable = false;
        PlayerPrefs.DeleteKey(PlayerPrefs.GetString("username") + "ManipulatePass");
        for (int i = 0; i < 20; i++)
        {
