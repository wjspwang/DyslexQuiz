...
public class ArithSubLevelSelectMenuControlScript : MonoBehaviour
{
    public Text score;
    ...
    void Start()
    {
        ...
        */
        ...
        ArithSubLevelPassed -= 136;
        Debug.Log(ArithSubLevelPassed + " levels passed");

        switch (ArithSubLevelPassed)
        {
            case 1:
        ...
        PlayerPrefs.SetInt(PlayerPrefs.GetString("username") + "SubScore", ActiveStarCounter);
        score.text = "Score: " + PlayerPrefs.GetInt(PlayerPrefs.GetString("username") + "SubScore");
        Debug.Log("SubScore is " + PlayerPrefs.GetInt(PlayerPrefs.GetString("username") + "SubScore"));
    }
    ...
    public void resetPlayerPrefs()
    {
        ...
        level20Button.interactable = false;
        */
        PlayerPrefs.DeleteKey(PlayerPrefs.GetString("username") + "ArithSubPass");
        for (int i = 0; i < 20; i++)
        {
