...
public class DeletingLevelSelectMenuControlScript : MonoBehaviour
{
    public Text score;
    ...
    void Start()
    {
        ...
        DeleteLevelPassed -= 47;
        Debug.Log(DeleteLevelPassed + "");
        switch (DeleteLevelPassed)
        {
            case 1:
        ...
        PlayerPrefs.SetInt(PlayerPrefs.GetString("username") + "DeleteScore", ActiveStarCounter);
        score.text = "Score: " + PlayerPrefs.GetInt(PlayerPrefs.GetString("username") + "DeleteScore");
        Debug.Log("DeleteScore is " + PlayerPrefs.GetInt(PlayerPrefs.GetString("username") + "DeleteScore"));
    ...
    public void resetPlayerPrefs()
    {
        ...
        level19Button.interactable = false;
        level20Button.interactable = false;
        PlayerPrefs.DeleteKey(PlayerPrefs.GetString("username") + "DeletePass");
        for (int i = 0; i < 20; i++)
        {
