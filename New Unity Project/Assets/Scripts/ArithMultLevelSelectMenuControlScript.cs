...
public class ArithMultLevelSelectMenuControlScript : MonoBehaviour
{
    public Text score;
    ...
    void Start()
    {
        ...
        */
        ...
        ArithMultLevelPassed -= 146;
        Debug.Log(ArithMultLevelPassed + "ArithMult levels passed");

        switch (ArithMultLevelPassed)
        {
            case 1:
        ...
        PlayerPrefs.SetInt(PlayerPrefs.GetString("username") + "MultScore", ActiveStarCounter);
        score.text = "Score: " + PlayerPrefs.GetInt(PlayerPrefs.GetString("username") + "MultScore");
        Debug.Log("MultScore is " + PlayerPrefs.GetInt(PlayerPrefs.GetString("username") + "MultScore"));
    }
    ...
    public void resetPlayerPrefs()
    {
        ...
        level09Button.interactable = false;
        level10Button.interactable = false;
        PlayerPrefs.DeleteKey(PlayerPrefs.GetString("username") + "ArithMultPass");
        for (int i = 0; i < 20; i++)
        {
